#!/usr/bin/env python3
"""
setup.py — one-shot setup for the incident-report feedback loop (solution).
...
covered — including a labeled hypothesis for the root cause. Never ask the \
engineer to confirm, refine, or quantify something they have already told \
you.
...
phrased as ONE single, short question. Never ask two questions in a turn, \
not even two phrasings of the same question, and never re-ask about a \
field you already have an answer for.
...
mention. Do not produce the final report while any field is still missing.
