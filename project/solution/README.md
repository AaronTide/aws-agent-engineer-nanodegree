...
This folder contains a complete reference solution for the customer support chatbot project.
...
**t2 — Platform question routing.** "What is your return policy?" should route to `FaqQuestion` and return a summary of the return policy from the embedded FAQ.
